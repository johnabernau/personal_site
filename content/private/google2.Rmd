...
* Does it make sense to control for both time (days_after) AND the lagged DV? Results are stable with and without the days_after time variable. I like the time variable because it's easier to tell a story ("controlling for time elapsed...").
