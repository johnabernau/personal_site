---
title: 'Data Exploration: Global Trends in Extreme Poverty'
...
<img src= "https://upload.wikimedia.org/wikipedia/commons/f/f8/Hobos2.jpg" height="400" align = "right" vspace = "50" hspace = "50" />

- [Importing data](#import)
- [Preparing data](#prep)
- [Merging data](#merge)
- [Plotting data](#plot)
- [Appendix: An 10-line code summary](#appendix)
...
```{r}
d <- read.csv("/Users/johnbernau/Box Sync/1. Desktop/4. Methods/1. R/worldbankpoverty/API.csv", skip = 4, stringsAsFactors = FALSE)
```
...
```{r}
m <- read.csv("/Users/johnbernau/Box Sync/1. Desktop/4. Methods/1. R/worldbankpoverty/Metadata.Country.csv", stringsAsFactors = FALSE)
```
