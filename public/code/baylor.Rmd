---
title: 'Plotting Regional Concentration of American Denominations'
...
In this post, I'll be using R to download, clean, and plot some basic descriptive stats about the regional concentration of American denominations using the [Baylor Religion Survey of 2010](https://www.baylor.edu/BaylorReligionSurvey/). 
...
final <- ggplot(bay3, aes(region)) + 
  ...
  labs(x="", y="", title="US Religon Distribution", subtitle= "Source: Baylor Religion Survey 2010")
final
```
